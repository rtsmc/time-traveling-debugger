...
./build_and_test.sh
```
This will build everything and run tests automatically!

### Step 2: Test
```bash
python runner.py test.py
```
Check that `trace.log` was created.

### Step 3: Examine
```bash
python parse_trace.py trace.log
```
See the trace file format and learn how to read it.

## 📁 Files You Have (13 total)
...
9. **setup.py** - Build configuration
10. **runner.py** - Runs Python files with tracing
11. **parse_trace.py** - Example trace parser (use for your CLI!)

### 🧪 **Test Files:**
12. **test.py** - Example working script
13. **test_crash.py** - Example crash script
